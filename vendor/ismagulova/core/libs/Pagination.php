...
class Pagination{
    ...
    public function getHtml(){
        ...
        return
            '<ul class="pagination justify-content-center">' . $startpage.$back.$page2left.$page1left.
            '<li class="active"><a class="page-link">' .$this->currentPage.'</a></li>'
